...
function CropperModal({ uploadedImageFile, onClose, onSubmit }) {
  ...
  const handleSubmit = useCallback(() => {
    ...
    const cavans = cropperRef.current.getCroppedCanvas();
    const baseStr = cavans.toDataURL();
    onSubmit(baseStr)
  ...
  return (
    <div className="hooks-cropper-modal">
      <div className="modal-panel" style={{ width: document.documentElement.clientWidth }}>
        <div className="cropper-container-container">
          <div className="cropper-container" style={{ height: document.documentElement.clientHeight * 0.7}}>
            <Cropper
        ...
        <div className="button-row">
          <div className="cancle-button" onClick={onClose}>
            取消
          </div>
