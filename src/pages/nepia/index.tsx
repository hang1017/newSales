...
import Nepia1Png from '@/assets/img/nepia/nepia1.png';
import Nepia2Png from '@/assets/img/nepia/nepia2.png';
import Nepia3Png from '@/assets/img/nepia/nepia3.png';
...
const NepiaPage: FC<NepiaPageProps> = ({ dispatch, location }) => {
  ...
  // {"source":"1","sn":"1","skuId":"1","salesCode":""}
  console.log(pars);
