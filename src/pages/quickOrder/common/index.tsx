...
import Blue5Png from '@/assets/img/quickOrder/blue5.png';
import Blue6Png from '@/assets/img/quickOrder/blue6.png';
      ...
      >
        <div>
          ...
          <div className={styles.commonContent}>
            ...
            <img src={Blue3Png} alt="" className={styles.commonImg} />
            <img src={Blue5Png} alt="" className={styles.commonImg} />
            <img
              src={Blue6Png}
              alt=""
