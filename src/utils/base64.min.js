...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : (function () {
        const r = e.Base64,
          n = t();
        (n.noConflict = () => ((e.Base64 = r), n)), e.Meteor && (Base64 = n), (e.Base64 = n);
      })();
})(
  ...
  function () {
    ...
    const e = 'function' == typeof atob,
      ...
      c = (e) => e.replace(/[+\/]/g, (e) => ('+' == e ? '-' : '_')).replace(/=+$/m, ''),
      ...
      l = t ? (e) => btoa(e) : r ? (e) => Buffer.from(e, 'binary').toString('base64') : s,
      d = r
        ? (e) => Buffer.from(e).toString('base64')
        : (e) => {
            let t = [];
            for (let r = 0, n = e.length; r < n; r += 4096)
              t.push(f.apply(null, e.subarray(r, r + 4096)));
            return l(t.join(''));
          },
      p = (e, t = !1) => (t ? c(d(e)) : d(e)),
      y = (e) => unescape(encodeURIComponent(e)),
      b = r ? (e) => Buffer.from(e, 'utf8').toString('base64') : (e) => l(y(e)),
      h = (e, t = !1) => (t ? c(b(e)) : b(e)),
      B = (e) => h(e, !0),
      g = (e) => decodeURIComponent(escape(e)),
      m = (e) => {
      ...
      A = e ? (e) => atob(u(e)) : r ? (e) => Buffer.from(e, 'base64').toString('binary') : m,
      U = r ? (e) => Buffer.from(e, 'base64').toString('utf8') : (e) => g(A(e)),
      w = (e) => u(e.replace(/[-_]/g, (e) => ('-' == e ? '+' : '/'))),
      S = (e) => U(w(e)),
      C = r ? (e) => i(Buffer.from(w(e), 'base64')) : (e) => i(A(w(e)), (e) => e.charCodeAt(0)),
      R = (e) => ({ value: e, enumerable: !1, writable: !0, configurable: !0 }),
      I = function () {
    ...
    return Object.keys(x).forEach((e) => (x.Base64[e] = x[e])), x;
  },
);
