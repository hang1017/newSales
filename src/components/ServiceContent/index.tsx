...
const Page: React.FC<ServiceItem> = (props) => {
  return (
    <div>
      中国电信用户入网协议
      <br />
      ...
      <br />
      2.甲方为个人用户的，通过电子渠道线上办理入网时使用二代居民身份证。
      <br />
      ...
      <br />
      10.甲方不得二次转售、倒卖名下持有的电话卡。如需转让给他人使用或实际使用人信息发生变化，甲方须按本协议关于用户真实身份信息登记的约定，办理过户手续或变更实际使用人信息，否则乙方有权采取关停号码、解除协议等措施。由此产生的后果，乙方不承担责任。
      <br />
      ...
      <br />
      14.为保护公共利益、优化电信服务质量、保障甲方电信服务知情权、及时警示通讯信息诈骗、创新电信服务体验，甲方同意乙方使用甲方个人信息通过营业网点、网站、短信、互联网媒体、电子邮件、语音外呼等方式，向甲方告知社会公益、电信服务、业务使用、诈骗风险警示等信息。
      <br />
      15.甲方有权自主选择携号转网服务，即在保持移动电话号码不变的情况下变更签约的电信运营企业。甲方办理携号转网业务应当符合工业和信息化部携号转网有关文件的规定条件和程序。
      <br />
      16.办理携号转网业务过程中，甲方同意乙方将必要的甲方身份信息提供给工业和信息化部集中业务管理系统（CSMS系统），用于比对携入方和携出方登记的身份信息是否一致。
      <br />
      三、乙方的权利和义务
      <br />
      ...
      <br />
      4.乙方可以通过营业网点、网站、电话、广播、短信、电子邮件、电视、公开张贴、信函、报纸、互联网媒体等一种或数种方式，公布、通知或告知业务种类和服务项目、范围、时限、资费方案以及其他电信服务内容。
      <br />
      ...
      <br />
      （2）后付方式下，甲方累计未交的费用到达信用额度、或到达交费期时，甲方应当及时充值或交费，否则乙方可暂停提供电信服务。其中，甲方当月累计出账费用的交费期为次月[]日至[]日，另有约定的除外。
      <br />
      （3）上述（1）、（2）欠费停机所涉业务，不包括单独的固定电话业务。固定电话业务的欠费停机时间按照《中华人民共和国电信条例》的相关规定执行。
      <br />
      12.甲方自欠费停机之日起60日内交清费用并申请复机的，乙方应当在收到甲方费用时起24小时内为甲方恢复暂停的电信服务（“复机”）。
      <br />
      13.如甲方自欠费停机之日起满60日仍未交清欠费和违约金，乙方有权自欠费停机第61日起终止提供电信服务，收回相应号码（“销户”）、解除本协议，以及通过信函、电话、诉讼或委托第三方等形式追缴欠费和违约金，并可以依法向征信机构提供甲方失信信息。
      <br />
      ...
      <br />
      （4）甲方未办理相关手续，自行改变电信服务使用性质、用途，或二次转售、倒卖电话卡，或自行转让协议的；
      <br />
      ...
      六、其他约定
      <br />
      1.所有因本协议引起的或与本协议有关的争议，双方将通过友好协商解决。协商不成的，双方均同意请求位于北京的中国国际经济贸易仲裁委员会依照其仲裁规则对争议事项进行仲裁。
      <br />
      ...
      <br />
      4.甲乙双方以电子方式签署本协议的，甲方可登录乙方网上营业厅查询、下载本协议。
      <br />
      甲方：（签名或单位盖章）
      <br />
      地址：
